...
export const fileNilReturn = async (credentials: {
  ...
  try {
    ...
    if (data.requiresPayment) {
      console.log('[FILING] Employment income detected, return NOT allowed as NIL');
      throw new Error(data.message || 'Employment income detected. You cannot file a NIL return.');
    }
