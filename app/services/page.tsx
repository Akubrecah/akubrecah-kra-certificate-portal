      ...
      <div className="container mx-auto px-6 max-w-6xl space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, i) => (
            ...
            <div className="glass-pro p-8 rounded-[2rem] border border-border h-full flex flex-col justify-between transition-all duration-500 hover:border-brand-cyan/30 hover:translate-y-[-4px] relative overflow-hidden">
                {/* Background Pattern */}
                ...
                <div className="relative z-10 space-y-6">
                  <div className={`h-14 w-14 rounded-2xl bg-muted/30 flex items-center justify-center border border-border group-hover:border-brand-cyan/50 transition-colors ${service.accent}`}>
                    {service.icon}
                  </div>
                  
                  <div className="space-y-3">
                    <h3 className="text-2xl font-black tracking-tight text-foreground group-hover:text-brand-cyan transition-colors">
                      {service.title}
                    </h3>
                ...
                <div className="relative z-10 pt-8 flex items-center justify-between border-t border-border mt-8">
                  <span className="text-xl font-black text-foreground">{service.price}</span>
                  <div className="h-10 w-10 rounded-full bg-muted/30 flex items-center justify-center group-hover:bg-brand-cyan group-hover:text-black transition-all">
        ...
        {/* Custom Service CTA */}
        <div className="glass-pro p-8 md:p-12 rounded-[2.5rem] border border-border flex flex-col md:flex-row items-center justify-between gap-8 mt-12 bg-gradient-to-br from-brand-cyan/5 to-transparent">
          <div className="space-y-2 text-center md:text-left">
            <h2 className="text-2xl font-black text-foreground tracking-tight">Need a custom filing solution?</h2>
