    ...
    <div className="space-y-6">
      ...
      {extractionStatus === "success" && (
        <Alert className="bg-brand-green/10 border-brand-green/20">
          ...
          <AlertTitle className="text-brand-green font-bold">Extraction Successful</AlertTitle>
      ...
      <div className="flex justify-between mt-6">
        <div></div>
        {extractionStatus === "success" ? (
          <Button type="button" onClick={onNext} className="bg-brand-cyan hover:bg-brand-cyan/90 text-black font-bold">
            Next Step
          </Button>
        ) : (
          <Button
            ...
            className="bg-brand-cyan hover:bg-brand-cyan/90 text-black font-bold"
          >
            {extractionStatus === "extracting" ? (
              <>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex justify-between mt-4">
        <Button type="button" variant="outline" onClick={onBack} className="border-brand-cyan/20 text-brand-cyan hover:bg-brand-cyan/5">
          Back
        </Button>
        <Button type="button" onClick={onNext} className="bg-brand-cyan hover:bg-brand-cyan/90 text-black font-bold">
          Next Step
...
export function Step4Payment({ paymentStatus, onPayment, mpesaNumber, setMpesaNumber, onBack, onNext }) {
  return (
    <div className="space-y-4">
      ...
      <Alert className="bg-brand-cyan/10 border-brand-cyan/20">
        <AlertCircle className="h-4 w-4 text-brand-cyan" />
        <AlertTitle className="text-brand-cyan font-bold">Service Fee: KES 30</AlertTitle>
        <AlertDescription className="text-brand-cyan/80">
      ...
      {paymentStatus === "paid" && (
        <Alert className="bg-brand-green/10 border-brand-green/20">
          <CheckCircle className="h-4 w-4 text-brand-green" />
          <AlertTitle className="text-brand-green font-bold">Payment Successful</AlertTitle>
          <AlertDescription className="text-brand-green/80">
    ...
    <div className="space-y-4">
      ...
      <div className="flex justify-between mt-4">
        ...
        <Button
          ...
          className="bg-gradient-to-r from-brand-green to-brand-cyan hover:scale-[1.02] transition-transform text-white font-bold"
        >
          {registrationStatus === "processing" ? (
            <>
              <Loader2 className="mr-2 h-4 w-4 animate-spin" />
