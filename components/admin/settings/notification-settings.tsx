          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <Textarea 
                ...
                defaultValue="admin@akubrecahentertainment.com, tech@akubrecahentertainment.com"
              />
              <p className="text-xs text-muted-foreground">
            ...
            <div className="space-y-4">
              ...
              <Input 
                ...
                defaultValue="https://monitors.akubrecahentertainment.com/webhooks/system-alerts"
              />
              <p className="text-xs text-muted-foreground">
