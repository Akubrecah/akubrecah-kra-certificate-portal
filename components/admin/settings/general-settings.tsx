    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        <div className="space-y-4">
          ...
          <Input 
            id="site-name" 
            placeholder="Akubrecah Entertainment" 
            defaultValue="Akubrecah Entertainment"
          />
        ...
        <div className="space-y-4">
          ...
          <Input 
            id="contact-email" 
            type="email" 
            placeholder="contact@akubrecahentertainment.com" 
            defaultValue="contact@akubrecahentertainment.com"
          />
        </div>
